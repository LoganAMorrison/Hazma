...
vrel = 1e-3
cme1 = 2. * mx1 * (1. + 0.5 * vrel**2)
cme2 = 2. * mx2 * (1. + 0.5 * vrel**2)

params1 = {"mx": mx1, "ms": ms1, "gsxx": gsxx,
           "gsff": gsff, "gsGG": gsGG, "gsFF": gsFF, "lam": lam}
params2 = {"mx": mx2, "ms": ms2, "gsxx": gsxx,
           "gsff": gsff, "gsGG": gsGG, "gsFF": gsFF, "lam": lam}
...
np.save('sm1_data/ann_cross_sections.npy',
        SM1.annihilation_cross_sections(cme1))
np.save('sm2_data/ann_cross_sections.npy',
        SM2.annihilation_cross_sections(cme2))


np.save('sm1_data/ann_branching_fractions.npy',
        SM1.annihilation_branching_fractions(cme1))
np.save('sm2_data/ann_branching_fractions.npy',
        SM2.annihilation_branching_fractions(cme2))
...
egams1 = np.logspace(0., np.log10(cme1), num=10)
egams2 = np.logspace(0., np.log10(cme2), num=10)

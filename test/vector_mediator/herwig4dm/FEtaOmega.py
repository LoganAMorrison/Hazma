...
def GammaDM(mMed):
    ...
    if Q > mEta_ + mOmega_:
        ...
        return 0.0
    amp = Resonance.BreitWignerFW(Q2, mOmega_p_, gOmega_p_) * a_Omega_p_ * cmath.exp(
        complex(0.0, phi_Omega_p_)
    ) + Resonance.BreitWignerFW(Q2, mOmega_pp_, gOmega_pp_) * a_Omega_pp_ * cmath.exp(

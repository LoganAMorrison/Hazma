...
def fermion(eng_gam, cme, mass_f):
    ...
    Computes the final state radiaton spectrum value dNdE given a gamma
    ray energy of `eng_gam`, center of mass energy `cme` and final state
    fermion mass `mass_f`.
    ...
    eng_gam : float
        Gamma ray energy.
    cme: float
        Center of mass energy of mass of off-shell mediator.
    mass_f : float

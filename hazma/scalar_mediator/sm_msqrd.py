"""Module containing squared matrix elements for the scalar mediator.
...
def msqrd_xx_s(self, s):
    return -(self.gsxx**2 * (4 * self.mx**2 - s)) / 2.
...
def msqrd_xx_to_s_to_pipig(self, moms):
    """Returns the spin-averaged, squared matrix element for a pair of fermions,
    *x*, annihilating into a pair of charged pion, and a photon through a
    ...
    mat_elem = self.msqrd_xx_s_pipig(Q, s, t)

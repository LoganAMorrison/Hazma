...
def amp_s_k0k0(s, params, unit='BSE'):
    ...
    if unit == 'BSE':
        ...
        amp_PIPI_k0k0 = amp_pipi_to_kk_bse(sqrt(s)) / sqrt(2)
        amp_KK_k0k0 = amp_kk_to_kk_bse(sqrt(s)) / sqrt(2)
...
def amp_s_pi0pi0(s, params, unit='BSE'):
    ...
    if unit == 'BSE':
        ...
        amp_PIPI_pi0pi0 = amp_pipi_to_pipi_bse(
            sqrt(s)) / sqrt(3)
        amp_KK_pi0pi0 = amp_kk_to_kk_bse(sqrt(s)) / sqrt(3)
...
def amp_s_pipi(s, params, unit='BSE'):
    ...
    if unit == 'BSE':
        ...
        amp_PIPI_pipi = amp_pipi_to_pipi_bse(sqrt(s)) / sqrt(3)
        amp_KK_pipi = amp_kk_to_kk_bse(sqrt(s)) / sqrt(3)

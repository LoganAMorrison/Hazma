...
cdef double kallen_lambda(double a, double b, double c):
    """
...
@cython.cdivision(True)
cdef double two_body_three_momentum(double cme, double m1, double m2):
    """
...
@cython.cdivision(True)
cdef double two_body_energy(double q, double m1, double m2):
    """

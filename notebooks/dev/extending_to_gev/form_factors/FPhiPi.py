# Libraries to load
import cmath,math,Resonance,alpha
...
mPhi = 1.019461
mpi  = 0.1349766
wgts = [amp[0]*cmath.exp(complex(0.,phase[0]/180.*math.pi)),
...
def sigmaDMPhiPi(sHat) :
    ...
    DMmed2 = abs(DMmed)**2
    return DMmed2/12./math.pi*ecms*(1+2*mDM_**2/sHat)*pcm**3*abs(form)**2*Resonance.gev2nb
